...
ARCHLDSCRIPT	:= -T"D:/quartus/University_Program/Monitor_Program/build/altera-socfpga-hosted.ld"
ASFLAGS		:= $(ARCHASFLAGS)
...
# Files
HDRS		:=
SRCS		:= AiSnake.h address_map_arm.h definition.h image.h interruptID.h main.c objects.h
OBJS		:= $(patsubst %, %.o, $(SRCS))

# Targets
COMPILE: AiSnake.srec

AiSnake.srec: AiSnake.axf
	$(RM) $@
	$(OC) $(OCFLAGS) $< $@
...
CLEAN: 
	$(RM) AiSnake.srec AiSnake.axf $(OBJS)
